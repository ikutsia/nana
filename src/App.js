  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background-light to-background-light-blue">
      ...
      <section id="awards" className="py-24 gradient-bg-dark text-white">
        <div className="container">
          <h2
            className={`font-bold text-center mb-16 text-white transition-all duration-300 hover:text-orange-400 hover:scale-105 hover:drop-shadow-lg ${
              language === "de"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div>
              <h3
                className={`font-bold mb-8 text-center text-white transition-all duration-300 hover:text-orange-400 hover:scale-105 hover:drop-shadow-lg ${
                  language === "de"
                    ? "text-2xl sm:text-3xl md:text-4xl lg:text-5xl"
                    : "text-3xl"
                }`}
